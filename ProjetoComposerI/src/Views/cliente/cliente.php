...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Clientes</h1>
        <a href="/cliente/inserir" class="btn btn-primary">Novo Cliente</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            <td><?= $c['nome'] ?></td>
                            <td>
                                <a href="/cliente/alterar/id_cliente/<?= $c["id_cliente"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/cliente/excluir/id_cliente/<?= $c["id_cliente"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
