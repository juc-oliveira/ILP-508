...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Cachorros</h1>
        <a href="/cachorro/inserir" class="btn btn-primary">Nova Cachorro</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            <td><?= $c['nome'] ?></td>
                            <td>
                                <a href="/cachorro/alterar/id_cachorro/<?= $c["id_cachorro"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/cachorro/excluir/id_cachorro/<?= $c["id_cachorro"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
