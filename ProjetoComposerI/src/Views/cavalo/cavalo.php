...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Cavalos</h1>
        <a href="/cavalo/inserir" class="btn btn-primary">Novo Cavalo</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            <td><?= $c['nome'] ?></td>
                            <td>
                                <a href="/cavalo/alterar/id_cavalo/<?= $c["id_cavalo"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/cavalo/excluir/id_cavalo/<?= $c["id_cavalo"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
