...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Gatos</h1>
        <a href="/gato/inserir" class="btn btn-primary">Nova Gato</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            <td><?= $c['nome'] ?></td>
                            <td>
                                <a href="/gato/alterar/id_gato/<?= $c["id_gato"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/gato/excluir/id_gato/<?= $c["id_gato"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
